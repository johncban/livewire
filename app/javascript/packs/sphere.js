...
var camera = new THREE.PerspectiveCamera(80, window.innerWidth / window.innerHeight, 0.1, 4000);
...
var materialRed = new THREE.MeshBasicMaterial({transparent: true,  color: 0xff0000,  opacity: 0.6,  side: THREE.DoubleSide});
...
for (var p = 0; p < pitchSegments; p++) {
  ...
  for (var e = 0; e < elevationSegments; e++) {
    ...
    var particle = new THREE.Mesh(geometry, materialRed);
