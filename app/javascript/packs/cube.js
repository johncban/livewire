var mousePos = {x:.5,y:.5};
    ...
    var materialGreen = new THREE.MeshBasicMaterial({transparent: true,  color: 0x626567,  opacity: 0.8,  side: THREE.DoubleSide});

    var pitchSegments = 60;
    var elevationSegments = pitchSegments/2;
    var particles = pitchSegments*elevationSegments
    var side = Math.pow(particles, 1/4);
    ...
    return ((place/side) - 0.5) * radius * 1.4;  
    }
